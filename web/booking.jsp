...
<html>
    <head>
        ...
        <style>
            ...
            #Remarks, #Country, input[type]:focus {
                box-shadow: none;
            }
        </style>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div style="margin-bottom: 10px">
                                    ...
                                    <span style="margin-left: 10px;">Free cancellation.</span>
                                </div>
                                <div>
                                    <svg class="bk-icon -streamline-checkmark_selected" fill="#008009" height="18" role="presentation" width="18" viewBox="0 0 128 128" aria-hidden="true" focusable="false"><path d="M56.62 93.54a4 4 0 0 1-2.83-1.18L28.4 67a4 4 0 1 1 5.65-5.65l22.13 22.1 33-44a4 4 0 1 1 6.4 4.8L59.82 91.94a4.06 4.06 0 0 1-2.92 1.59zM128 64c0-35.346-28.654-64-64-64C28.654 0 0 28.654 0 64c0 35.346 28.654 64 64 64 35.33-.039 63.961-28.67 64-64zm-8 0c0 30.928-25.072 56-56 56S8 94.928 8 64 33.072 8 64 8c30.914.033 55.967 25.086 56 56z"></path></svg>
                                    ...
                                    <div class="modal-body">
                                        <form action="booking" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label class="col-form-label" for="login">Email <span class="text-danger">*</span></label>
                                            ...
                                            <div class="submit-section" style="
                                                 ...
                                                 ">
                                                <hr>
                                                <input type="submit" class="btn btn-primary" value="Continue with email" style="
                                                       width: 100%;
                                                       padding: 8px 0px;
                                                       margin-bottom: 5px;
                                                       ">
                                                <div class="least-important-details">
                                                    By signing in, you agree to our <a href="javascript:void(0)">terms and services</a>, privacy <a href="javascript:void(0)">policy</a>.
                                                </div>
                                                <hr>
                                                <div class="least-important-details" style="text-align: center;">
                                                    All rights reserved.<br>
                                                    Copyright (2022 - 2022) - MyHotel.com™
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <form class="col-sm-12" id="customerDetailForm" action="booking">
                            ...
                            <c:forEach items="${listRoom}" var="listR">
                                <div class="card" style="background: #ebf3ff;">
                                    <div class="card-body">
                                        <input type="hidden" name="RoomID" value="${listR.getRoomID()}">
                                        <input type="hidden" name="RoomName" value="${listR.getRoomName()}">
                                        <h4>${listR.getName()}</h4>
                                        ...
                                        <strong style="color: green;">Free cancellation</strong> 
