                        ...
                        <div class="card" style="background: #ebf3ff;">
                            <div class="card-body">
                                ...
                                <div style="margin-bottom: 5px;">
                                    <strong>Fits: </strong>2 adults, 2 children
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                        ...
                        <div class="card" style="background: #ebf3ff;">
                            <div class="card-body">
                                ...
                                <div style="margin-bottom: 15px">
                                    ...
                                    <span style="margin-left: 5px;">Your rooms will be ready for check-in between 14:00 and 00:00</span>
                                </div>
                                <div style="margin-bottom: 15px">
                                    ...
                                    <span style="margin-left: 5px;">24-hour front desk – Help whenever you need it!</span>
                                </div>
                            </div>
                        </div>
                    </div>
