                    ...
                    <div class="">
                        <ul class="" style="list-style: none; padding-left: 1rem;">
                            ...
                            <li style="${settingOption == 2 ? " text-decoration: underline;" : ""}">
                                <h6>
                                    <a class="settings-menu" href="customer?do=displayAccountSecurity">
