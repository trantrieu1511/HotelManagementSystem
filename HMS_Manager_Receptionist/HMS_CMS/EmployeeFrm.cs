...
namespace ContentManagementSystem
{
    public partial class EmployeeFrm : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            using (MyHotelContext context = new MyHotelContext())
            {
                ...
                Employee emp = new Employee
                {
                    ...
                    ReportsTo = cboReportsTo.SelectedValue.ToString()
                };
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            using (MyHotelContext context = new MyHotelContext())
            {
                ...
                Employee emp = context.Employees
                    .SingleOrDefault(item => item.EmpId == txtEmpID.Text);
                ...
                emp.ReportsTo = cboReportsTo.SelectedValue.ToString();
                ...
                case "dob":
                    {
                        ...
                        using (MyHotelContext context = new MyHotelContext())
                        {
                            var result = context.Employees
                                ...
                                .AsEnumerable()
                                .Where(emp => emp.DOB <= dtpDOB.Value)
                                .ToList();
        ...
        private void dgEmployee_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtAddress.Text = dgEmployee.Rows[e.RowIndex].Cells[4].FormattedValue.ToString();
            ...
            dtpDOB.Value = (dgEmployee.Rows[e.RowIndex].Cells[5].FormattedValue.ToString() != "" ?
                Convert.ToDateTime(dgEmployee.Rows[e.RowIndex].Cells[5].FormattedValue.ToString()) :
                Convert.ToDateTime("01/01/1990"));
            dtpHireDate.Value = (dgEmployee.Rows[e.RowIndex].Cells[6].FormattedValue.ToString() != "" ?
                Convert.ToDateTime(dgEmployee.Rows[e.RowIndex].Cells[6].FormattedValue.ToString()) :
                Convert.ToDateTime("01/01/1990"));
            ...
            cboReportsTo.SelectedValue = dgEmployee.Rows[e.RowIndex].Cells[11].FormattedValue.ToString();
        }
    }
}
