...
--insert Room
insert into Room([Name],RoomTypeID,[Floor],[View]) values('101', 1, 1, 'Street view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('102', 1, 1, 'No view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('103', 1, 1, 'No view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('104', 1, 1, 'Normal view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('105', 1, 1, 'Street view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('106', 1, 1, 'Normal view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('201', 2, 2, 'Beautiful Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('202', 2, 2, 'Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('203', 2, 2, 'Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('204', 2, 2, 'Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('205', 2, 2, 'Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('206', 2, 2, 'Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('301', 2, 3, 'Beautiful Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('302', 2, 3, 'Beautiful Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('401', 3, 4, 'Beautiful Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('402', 3, 4, 'Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('403', 3, 4, 'Beautiful Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('404', 3, 4, 'Beautiful Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('405', 3, 4, 'Magnificent Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('406', 3, 4, 'Great Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('407', 4, 4, 'Beautiful Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('408', 4, 4, 'Beautiful Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('409', 4, 4, 'Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('410', 4, 4, 'Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('501', 5, 5, 'Beachfront view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('502', 5, 5, 'Beautiful Beach view')
insert into Room([Name],RoomTypeID,[Floor],[View]) values('503', 5, 5, 'Beautiful Beach view')
